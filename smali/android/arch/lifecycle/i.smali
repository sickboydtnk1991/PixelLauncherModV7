.class synthetic Landroid/arch/lifecycle/i;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/i;->T:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Landroid/arch/lifecycle/i;->T:[I

    sget-object v2, Landroid/arch/lifecycle/Lifecycle$State;->H:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    :try_start_1
    sget-object v2, Landroid/arch/lifecycle/i;->T:[I

    sget-object v3, Landroid/arch/lifecycle/Lifecycle$State;->I:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    :try_start_2
    sget-object v3, Landroid/arch/lifecycle/i;->T:[I

    sget-object v4, Landroid/arch/lifecycle/Lifecycle$State;->J:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    :try_start_3
    sget-object v4, Landroid/arch/lifecycle/i;->T:[I

    sget-object v5, Landroid/arch/lifecycle/Lifecycle$State;->K:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sget-object v6, Landroid/arch/lifecycle/Lifecycle$State;->G:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    sput-object v5, Landroid/arch/lifecycle/i;->F:[I

    :try_start_5
    sget-object v5, Landroid/arch/lifecycle/i;->F:[I
